---
title: "DETECT 1-Year Fidelity and Agreement"
format: html
#editor: visual
---
...
-   General Performance
    ...
    -   85.05% of potentially eligible calls received a DETECT Screening (N = 24,007)

    -   91.93% of potentially eligible subjects received a DETECT Screening (N = 15,212)

-   Item Completion

    -   All 14 items were completed in 13,859 DETECT Screenings (57.73%)

    -   10 items were completed in 10,026 DETECT Screenings (41.76%) (almost exclusively due to missing caregiver questions)

    -   Less than 10 items were completed in only 16 DETECT Screenings (0.07%)

-   Fidelity to Reporting

    -   Overall, 1.74% of responses had a matching APS Intake (N=492)

        -   Reduced to 0.98% when only taking EMS/EMT specific intakes (N=278)

        -   Of these, 5.69% did not have an associated DETECT screening (N=28)

            -   Reduced to 2.52% when only taking EMS/EMT specific intakes (N=7)

        -   Of these, 65.24% were associated with a \*positive\* DETECT screening (N=321)

            -   Increased to 94.24% when only taking EMS/EMT specific intakes (N=262)

            -   Of these, 56.91% had an indication of intent to report (N=280)

                -   Increased to 87.77% when only taking EMS/EMT specific intakes (N=244)

            -   Of these, 20.53% were also matched within MedStar Compliance Data (N=101)

                -   Increased to 33.45% when only taking EMS/EMT specific intakes (N=93)

    -   3.63% of screenings were positive (N=871)

        -   Of these, 37.66% indicated an intent to report (N=328)

            -   Of these, 83.22% were matched to an APS Intake (N=273)

                -   Reduced to 72.87% when only taking EMS/EMT specific Intakes (N=239)

                -   Of these, 32.23% were matched to MedStar Compliance Data (N=88)

                    -   Increased to 33.47% when only taking EMS/EMT specific Intakes (N=80)

        -   Of the records that either denied or failed to indicate if a report to APS was made...

            -   8.84% were matched to an APS intake (N=48)

                -   Reduced to 4.24% when only taking EMS/EMT specific intakes (N=23)

                -   18.75% were matched to MedStar Compliance Data (N=9)

                    -   Increased to 39.13% when only taking EMS/EMT specific Intakes (N=9)

    -   96.37% of screenings were negative (N=23,136)

        -   Of these, 0.04% indicated an intent to report (N=10)

            -   Of these, 70% were matched to an APS Intake (N=7)

                -   Reduced to 50% when only taking EMS/EMT specific Intakes (N=5)

                -   Of these, 0% were matched to MedStar Compliance Data (N=0)

        -   Of the records that either denied or failed to indicate if a report to APS was made...

            -   0.59% were matched to an APS intake (N=136)

                -   Reduced to 0.02% when only taking EMS/EMT specific intakes (N=4)

                -   0% were matched to MedStar Compliance Data (N=0)

    -   Agreement of Intent to Report and Successful APS Matching

        -   Kappa of 0.693 (substantial agreement) when including missing intent as a lack of intent

            -   Decreased to 0.799 (substantial agreement) when only using EMS/EMT specific intakes

        -   1.408% of screenings included intent to report (N=338)

            -   Of these, 82.840% were matched with an APS Intake(N=280)

                -   Decreased to 72.189% when only using EMS/EMT specific intakes (N=244)

        -   98.500% of screenings included a lack of intent to report (N=23,647)

            -   Of these, 0.778% were matched with an APS Intake (N=184)

                -   Decreased to 0.114% when only using EMS/EMT specific intakes (N=27)

        -   0.0916% of screenings lacked an indication of intent to report (N=22)

            -   Of these, 0% were matched with an APS Intake (N=0)

    -   Agreement of DETECT Screening and APS Determination

        -   Subject-level Kappa of 0.169 (slight agreement) when including subjects unmatched with the APS data set as "negative" for EM determination status

            -   Decreased to 0.051 (slight agreement) when excluding subjects that were unmatched with the APS data set

        -   Temporally-Matched APS Case level Kappa of 0.309 (fair agreement) when including responses lacking a temporally-linked APS Case Number as "negative" for EM determination status

            -   Decreased to 0.097 (slight agreement) when excluding responses lacking a temporally-linked APS Case Number

        -   Direct-Paired APS Intake level Kappa of 0.419 (moderate agreement) when including responses lacking a directly-paired APS Intake as "negative" for EM determination status

            -   Decreased to 0.134 (slight agreement) when excluding responses lacking a directly-paired APS Intake

        -   Direct-Paired EMS/EMT specific APS Intake level Kappa of 0.393 (moderate agreement) when including responses lacking a directly-paired EMS/EMT specific APS intake as "negative" for EM determination status

            -   Decreased to 0.061 (slight agreement) when excluding responses lacking a directly-paired EMS/EMT specific intake

        -   3.628% of screenings were positive (N=871)

            -   Subject-level:

                -   63.280% were associated with a subject that was present in the APS data set (N=517)

                    -   52.813% were associated with a subject with at least one valid allegation of EM (N=460)

                    -   6.544% were associated with a subject with no valid allegations of EM (N=57)

                    -   40.643% were not associated with a subject in the APS Data set (N=354)

            -   Temporally-Matched APS Case Level:

                -   45.006% were associated with a temporally-linked APS Case Number that was present in the APS data set (N=392)

                    -   37.887% were associated with a temporally-linked APS Case Number with at least one valid allegation of EM (N=330)

                    -   7.118% were associated with a temporally-linked APS Case Number with no valid allegations of EM (N=62)

                -   54.994% were not associated with a temporally-linked APS Case Number in the APS Data set (N=479)

            -   Direct-Paired APS Intake level:

                -   36.854% were associated with a direct-pair APS Intake that was present in the APS data set (N=321)

                    -   30.769% were associated with a direct-pair APS Intake with at least one valid allegation of EM (N=268)

                    -   6.085% were associated with a direct-pair APS Intake with no valid allegations of EM (N=53)

                -   63.146% were not associated with a direct-pair APS Intake in the APS Data set (N=550)

            -   Direct-Paired EMS/EMT specific APS Intake level:

                -   30.080% were associated with a direct-pair EMS/EMT specific APS Intake that was present in the APS data set (N=262)

                    -   25.373% were associated with a direct-pair EMS/EMT specific APS Intake with at least one valid allegation of EM (N=221)

                    -   4.705% were associated with a direct-pair EMS/EMT specific APS Intake with no valid allegations of EM (N=41)

                -   69.920% were not associated with a direct-pair EMS/EMT specific APS Intake in the APS Data set (N=609)

        -   96.372% of screenings were negative (N=23,136)

            -   Subject-level:

                -   17.514% were associated with a subject that was present in the APS data set (N=4,052)

                    -   12.543% were associated with a subject with at least one valid allegation of EM (N=2,902)

                    -   4.971% were associated with a subject with no valid allegations of EM (N=1,150)

                    -   82.468% were not associated with a subject in the APS Data set (N=19,084)

            -   Temporally-Matched APS Case Level:

                -   4.737% were associated with a temporally-linked APS Case Number that was present in the APS data set (N=1096)

                    -   3.268% were associated with a temporally-linked APS Case Number with at least one valid allegation of EM (N=756)

                    -   1.470% were associated with a temporally-linked APS Case Number with no valid allegations of EM (N=340)

                -   95.263% were not associated with a temporally-linked APS Case Number in the APS Data set (N=22,040)

            -   Direct-Paired APS Intake level:

                -   0.618% were associated with a direct-pair APS Intake that was present in the APS data set (N=143)

                    -   0.441% were associated with a direct-pair APS Intake with at least one valid allegation of EM (N=102)

                    -   0.177% were associated with a direct-pair APS Intake with no valid allegations of EM (N=41)

                -   99.382% were not associated with a direct-pair APS Intake in the APS Data set (N=22,993)

            -   Direct-Paired EMS/EMT specific APS Intake level:

                -   0.039% were associated with a direct-pair EMS/EMT specific APS Intake that was present in the APS data set (N=9)

                    -   0.026% were associated with a direct-pair EMS/EMT specific APS Intake with at least one valid allegation of EM (N=6)

                    -   0.013% were associated with a direct-pair EMS/EMT specific APS Intake with no valid allegations of EM (N=3)

                -   99.961% were not associated with a direct-pair EMS/EMT specific APS Intake in the APS Data set (N=23,127)

    -   Agreement of DETECT Screening Result and Reporting

        -   Kappa of 0.467 (moderate agreement) between DETECT screening result and presence of a matched APS Intake/Report

            -   Decreased to 0.449 (moderate agreement) when only including EMS/EMT specific APS Intakes

        -   3.628% of screenings were positive (N=871)

            -   33.854% were matched to an APS Intake (N=321)

                -   Reduced to 30.080% when only including EMS/EMT specific APS Intakes (N=262)

            -   63.145% were not matched to an APS Intake (N=550)

                -   Increased to 69.919% when only including EMS/EMT specific APS Intakes (N=609)

        -   96.372% of screenings were negative (N=23,136)

            -   0.618% were matched to an APS Intake (N=143)

                -   Reduced to 0.039% when only including EMS/EMT specific APS Intakes (N=9)

            -   99.382% were not matched to an APS Intake (N=22,993)

                -   Increased to 99.961% when only including EMS/EMT specific APS Intakes (N=23,127)
...
## Agreement of DETECT Screening Items and APS Determinations

We re-imported the temporal-case matching data set, and isolated our DETECT screening item variables and APS determination outcome variables.
...
aps_outcome_vars <- case_data %>%
  select(aps_person_id, aps_case_num, aps_row, aps_reporter, 
         aps_subject_any_valid, aps_cases_any_valid) %>%
  names()
```

### Including Unmatched APS as "Negative"

#### Subject-Level

We calculated the Kappa agreement between a "Yes" response to each DETECT variable and the presence of at least one valid allegation of EM in the APS data set at the subject level, with subjects missing from the APS data set considered "negative" for the APS outcome. The highest agreement was with `detect_cond_hygiene` (0.317, fair), and the lowest was with `detect_caregiver_anxious` (0.274, slight). Overall, the caregiver questions had the lowest agreement. 

```{r}
checking <- case_data %>%
  select(all_of(detect_questions), all_of(aps_outcome_vars)) %>%
  mutate(aps_subject_any_valid = ifelse(is.na(aps_subject_any_valid), FALSE, 
                                               aps_subject_any_valid))

kappa_cols <- c("detect_item", "observed_perc", "expected_perc", "kappa")

kappa_table <- tibble::tibble(!!!kappa_cols, .rows = 0, 
                               .name_repair = ~kappa_cols)

for (i in 1:length(detect_questions)){
  checking_subset <- checking %>%
    filter(!is.na(detect_questions[i])) %>%
    select(detect_questions[i], all_of(aps_outcome_vars)) %>%
    rename_at(detect_questions[i], ~'detect_item')
  
  n_yes_apspos <- nrow(checking_subset %>%
    filter(detect_item == "YES" & aps_subject_any_valid))
  
  n_yes_apsneg <- nrow(checking_subset %>%
    filter(detect_item == "YES" & !aps_subject_any_valid))
  
  n_no_apspos <- nrow(checking_subset %>%
    filter(detect_item != "YES" & aps_subject_any_valid))
  
  n_no_apsneg <- nrow(checking_subset %>%
    filter(detect_item != "YES" & !aps_subject_any_valid))
  
  
  observed_aggr <- (n_yes_apspos + n_no_apsneg) / nrow(checking_subset)
  observed_aggr * 100

  expected_p_y <- ((n_yes_apspos + 
                      n_yes_apsneg) * (n_yes_apspos + 
                                         n_no_apspos)) / nrow(checking_subset)
  expected_n_n <- ((n_no_apspos + 
                      n_no_apsneg) * (n_yes_apsneg + 
                                        n_no_apsneg)) / nrow(checking_subset)
  expected_aggr <- (expected_p_y + expected_n_n) / nrow(checking_subset)
  expected_aggr * 100
  ...
  temp_tibb <- tibble::tibble("detect_item" = detect_questions[i],
                              "observed_perc" = observed_aggr*100,
                              "expected_perc" = expected_aggr*100,
                              "kappa" = kappa)
  
  kappa_table <- rbind(kappa_table, temp_tibb)
}
...
We calculated the Kappa agreement between a "Yes" response to each DETECT variable and the presence of at least one valid allegation of EM in the APS data set at the temporal-case level, with responses unmatched or missing from the APS data set considered "negative" for the APS outcome. The highest agreement was with `detect_cond_needs` (0.417, moderate), and the lowest was with `detect_caregiver_inattentive` (0.312, fair). Overall, the caregiver questions had the lowest agreement. 

```{r}
checking <- case_data %>%
  select(all_of(detect_questions), all_of(aps_outcome_vars)) %>%
  mutate(aps_cases_any_valid = ifelse(is.na(aps_cases_any_valid), FALSE, 
                                               aps_cases_any_valid))
...
for (i in 1:length(detect_questions)){
  ...
  n_yes_apspos <- nrow(checking_subset %>%
    filter(detect_item == "YES" & aps_cases_any_valid))
...
#### Broad Direct Pairing Level

We calculated the Kappa agreement between a "Yes" response to each DETECT variable and the presence of at least one valid allegation of EM in the APS data set at the broad direct-pairing level, with responses unmatched or missing from the APS data set considered "negative" for the APS outcome. The highest agreement was with `detect_env_concern` (0.455, moderate), and the lowest was with `detect_caregiver_inattentive` (0.324, fair). Overall, the caregiver questions had the lowest agreement. 
...
checking <- case_data %>%
  ...
  mutate(aps_cases_any_valid = ifelse(is.na(aps_cases_any_valid), FALSE, 
                                               aps_cases_any_valid)) %>%
  mutate(aps_cases_any_valid = ifelse(is.na(aps_row), FALSE,
                                      aps_cases_any_valid))
...
#### EMS/EMT Specific Direct Pairing Level

We calculated the Kappa agreement between a "Yes" response to each DETECT variable and the presence of at least one valid allegation of EM in the APS data set at the broad direct-pairing level, with responses unmatched or missing from the APS data set considered "negative" for the APS outcome. The highest agreement was with `detect_env_concern` (0.460, moderate), and the lowest was with `detect_caregiver_inattentive` (0.326, fair). Overall, the caregiver questions had the lowest agreement. 
...
### Excluding Unmatched APS

#### Subject-Level

We calculated the Kappa agreement between a "Yes" response to each DETECT variable and the presence of at least one valid allegation of EM in the APS data set at the subject level, with subjects missing from the APS data set excluded. The highest agreement was with `detect_caregiver_lack` (0.088, slight), and the lowest was with `detect_meds_hoarding` (0.052, slight). Overall, the caregiver questions had the lowest agreement. 
...
We calculated the Kappa agreement between a "Yes" response to each DETECT variable and the presence of at least one valid allegation of EM in the APS data set at the temporal-case level, with responses unmatched or missing from the APS data set excluded. The highest agreement was with `detect_env_odor` (0.111, slight), and the lowest was with `detect_cond_anxious` (0.059, slight).  
...
We calculated the Kappa agreement between a "Yes" response to each DETECT variable and the presence of at least one valid allegation of EM in the APS data set at the broad direct-pairing level, with responses unmatched or missing from the APS data set excluded. The highest agreement was with `detect_env_concern` (0.144, slight), and the lowest was with `detect_cond_anxious` (0.016, slight). 
...
We calculated the Kappa agreement between a "Yes" response to each DETECT variable and the presence of at least one valid allegation of EM in the APS data set at the broad direct-pairing level, with responses unmatched or missing from the APS data set excluded. The highest agreement was with `detect_env_concern` (0.191, slight), and the lowest was with `detect_cond_anxious` (0.002, slight). 
