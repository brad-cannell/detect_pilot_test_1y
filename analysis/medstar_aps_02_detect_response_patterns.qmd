...
We also made an alternative version of the data set for sensitivity analysis. This version eliminated any paired APS Intakes which were not explicitly an "EMS/EMT" reporter.
