...
```{r}
ms_epcr <- readRDS(here("data","DETECT Shared GRAs","medstar_cleaning",
                             "medstar_epcr_01.rds"))
```
...
Patient Zip code data, in `pt_address_zip`, was coded as character to preserve leading zeros and formatting. For the purposes of numeric matching with fastLink, it was converted to a numeric.

```{r}
ms_epcr$pt_address_zip <- as.numeric(ms_epcr$pt_address_zip)
```
...
```{r}
# fastLink Output
saveRDS(fl_out,here("data","DETECT Shared GRAs","medstar_cleaning",
                             "medstar_epcr_02_fastlinkobj.rds"))

# Stacked Pairs with Posteriors > 0.54
saveRDS(test_stack,here("data","DETECT Shared GRAs","medstar_cleaning",
                             "medstar_epcr_02_stacked_pairs.rds"))

# Original ID assignments
saveRDS(test_id,here("data","DETECT Shared GRAs","medstar_cleaning",
