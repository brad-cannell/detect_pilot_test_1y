...
medstar <- readRDS(here("data", "02 Shared Folders", "DETECT Shared GRAs", 
                        "medstar_cleaning", "medstar_02.rds"))
```
...
aps <- readRDS(here("data", "02 Shared Folders", "DETECT Shared GRAs", 
                    "aps_cleaning", "aps_04.rds"))
```

We imported the Group ID merge pattern for processing.

```{r}
merge_pattern <- readRDS(here("data", "02 Shared Folders", "DETECT Shared GRAs", 
                              "merge_aps_medstar",
...
```{r}
medstar <- readRDS(here("data", "02 Shared Folders", "DETECT Shared GRAs", "medstar_cleaning",
                        "medstar_02.rds"))
```
...
saveRDS(intake_response_pairs, 
        here("data", "02 Shared Folders", "DETECT Shared GRAs", 
             "merge_aps_medstar", "medstar_aps_full_row_map_01.rds"))
```
