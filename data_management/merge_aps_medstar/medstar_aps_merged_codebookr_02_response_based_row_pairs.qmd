---
title: "Medstar_aps_merged_02_response_based_row_pairs Codebook"
format: html
editor: visual
---
...
Our MedStar-based Paired Data Set contained 28,228 observations of 136 variables. There were 16,565 unique subject IDs, corresponding to 16,565 MedStar Subject IDs and 1,967 APS Person IDs. there were 461 APS Case Numbers represented in the data set.
...
for (i in aps_vars){
  attr(merged_data[[i]], "skip_pattern") <- 
    "APS Intake and Case Number level values were absent for responses that lacked a paired APS Intake. APS Subject level values were absent for Subjects that were not found in the APS data set."
}
```
...
medstar_aps_merged_02_response_based_row_pairs <- merged_data

book <- codebook(
  df = medstar_aps_merged_02_response_based_row_pairs,
  title = "DETECT 1-Year",
  subtitle = "All MedStar Responses with Data from Paired APS Intakes",
