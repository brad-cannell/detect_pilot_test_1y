...
```{r}
merged_time <- readRDS(here("data","DETECT Shared GRAs","merge_aps_medstar",
                              "medstar_aps_merged_01_timeline_all_rows.rds"))
```

```{r}
merged_pairs <- readRDS(here("data","DETECT Shared GRAs","merge_aps_medstar",
                "medstar_aps_merged_02_response_based_row_pairs.rds"))
```

```{r}
merged_subj <- readRDS(here("data","DETECT Shared GRAs","merge_aps_medstar",
