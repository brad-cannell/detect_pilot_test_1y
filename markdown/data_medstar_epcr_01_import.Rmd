...
medstar_epcr <- readxl::read_excel(
  path = "/Volumes/sph_research/Detect/phase_two/medstar_epcr.xlsx",
...
```{r}
feather::write_feather(medstar_epcr, "/Volumes/sph_research/DETECT/phase_two/medstar_epcr_01_import.feather")
```
