...
medstar_epcr <- readxl::read_excel(
  path = "/Volumes/sph_research/Detect/one_year_data/medstar_epcr.xlsx",
...
```{r}
feather::write_feather(medstar_epcr, "/Volumes/sph_research/DETECT/one_year_data/medstar_epcr_01_import.feather")
```
