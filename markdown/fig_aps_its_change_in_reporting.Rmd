...
```{r}
aps_its <- feather::read_feather("/Volumes/DETECT/one_year_data/aps_its.feather")
```
...
gridExtra::grid.arrange(medic_plot, non_medic_plot)
```



```{r}
# fig_aps_its_change_in_reporting_medics <- medic_weekly_reports_by_service_area %>% 
  # ggplot(aes(study_week, reports)) +
  #   
  #   # Add DETECT study periods
  #   geom_rect(aes(xmin = 38, xmax = 43, ymin = -Inf, ymax = Inf), fill = "lightyellow") +
