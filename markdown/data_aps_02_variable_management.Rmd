...
```{r}
aps_cleaned <- aps_2 %>% select(!ends_with(".y") & (!ends_with(".x")))
aps_unique <- aps_cleaned %>% filter(case_row==1)
```
...
Booma and Steph left off here...



Steph attempted to pick up here...
...
```{r}
# dim(aps_2) # 18,080 observations and 78 variables
```
