...
aps_3$county <- as.character(aps$county)
aps_3$city <- as.character(aps$city)
aps_3$zip <- as.character(aps$zip)
aps_3$street <- as.character(aps$street)

aps_3$case_num <- as.character(aps$case_num)
