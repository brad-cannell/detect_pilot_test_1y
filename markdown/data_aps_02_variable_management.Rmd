...
```{r}
aps <- feather::read_feather("/Volumes/DETECT/one_year_data/aps_01_import.feather")
```
...
```{r}
about_data(aps) # 18,080 observations and 59 variables
```
...
```{r}
feather::write_feather(aps, "/Volumes/DETECT/one_year_data/aps_02_variable_management.feather")
```
